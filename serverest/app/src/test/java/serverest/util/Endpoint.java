...
public class Endpoint {
    ...
    public static final String carrinhosCancelarCompra = "/carrinhos/cancelar-compra";
    public static final String carrinhosConcluirCompra = "/carrinhos/concluir-compra";
